...
export default function DuniaDistopia() {
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      <div className="max-w-4xl mx-auto px-6 py-20 space-y-16">
        ...
        <section className="prose prose-lg max-w-none leading-relaxed space-y-4">
          <h2 className="text-2xl font-semibold text-zinc-900">Bagian 1: Dunia dan Asal Usul yang Gelap</h2>
          <p>
        ...
        <section className="prose prose-lg max-w-none leading-relaxed space-y-4">
          <h2 className="text-2xl font-semibold text-zinc-900">Bagian 2: Pertemuan yang Mengubah Takdir</h2>
          <p>
        ...
        <section className="prose prose-lg max-w-none leading-relaxed space-y-4">
          <h2 className="text-2xl font-semibold text-zinc-900">Bagian 3: Kebersamaan dan Pencarian Jati Diri</h2>
          <p>
        ...
        <section className="prose prose-lg max-w-none leading-relaxed space-y-4">
          <h2 className="text-2xl font-semibold text-zinc-900">Bagian 4: Tragedi, Kebenaran, dan Pengorbanan</h2>
          <p>
        ...
        <section className="prose prose-lg max-w-none leading-relaxed space-y-4">
          <h2 className="text-2xl font-semibold text-zinc-900">Bagian 5: Akhir dan Warisan</h2>
          <p>
