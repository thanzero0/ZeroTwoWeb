    ...
    <div className="min-h-screen bg-white text-zinc-900">
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <section className="prose prose-lg max-w-none leading-relaxed space-y-4">
          <h2 className="text-2xl font-semibold text-zinc-900">Bagian 1: Kandang yang Diberi Nama</h2>
          <p>
        ...
        <section className="prose prose-lg max-w-none leading-relaxed space-y-4">
          <h2 className="text-2xl font-semibold text-zinc-900">Bagian 2: Kebencian yang Menjadi Pelindung</h2>
          <p>  
        ...
        <section className="prose prose-lg max-w-none leading-relaxed space-y-4">
          <h2 className="text-2xl font-semibold text-zinc-900">Bagian 3: Identitas sebagai "Pembunuh</h2>
          <p>
        ...
        <section className="prose prose-lg max-w-none leading-relaxed space-y-4">
          <h2 className="text-2xl font-semibold text-zinc-900">Bagian 4: Mimpi yang Tak Terungkap</h2>
          <p>
        ...
        <section className="prose prose-lg max-w-none leading-relaxed space-y-4">
          <h2 className="text-2xl font-semibold text-zinc-900">Bagian 5: Pertemuan yang Mengubah Segalanya</h2>
          <p>
        ...
        <section className="prose prose-lg max-w-none leading-relaxed space-y-4">
          <h2 className="text-2xl font-semibold text-zinc-900">Bagian 6: Perjalanan Mencari Diri</h2>
          <p>
